...
@Singleton
@Component(modules = [AndroidSupportInjectionModule::class, NetworkModule::class, MovieListActivityModule::class, DataBaseModule::class, DetailActivityModule::class, FavoriteActivityModule::class])
